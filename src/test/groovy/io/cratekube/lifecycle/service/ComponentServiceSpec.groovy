                  ...
                  "items": [
                      {
                          "spec": {
                              "containers": [
                                  {
                                      "name": "${nm}",
                                      "image": "dockerhub.cisco.com\/crate-docker\/${nm}:${curVersion}"
                                  }
                              ]
                          },
                          "status": {
                  ...
                  "items": [
                      {
                          "spec": {
                              "containers": [
                                  {
                                      "name": "${nm}",
                                      "image": "dockerhub.cisco.com\/crate-docker\/${nm}:${latVersion}"
                                  }
                              ]
                          },
                          "status": {
                  ...
                  "items": [
                      {
                          "spec": {
                              "containers": [
                                  {
                                      "name": "${name}",
                                      "image": "dockerhub.cisco.com\/crate-docker\/${name}:${curVersion}"
                                  }
                              ]
                          },
                          "status": {
